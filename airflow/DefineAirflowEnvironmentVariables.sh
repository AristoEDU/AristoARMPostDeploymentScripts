...
declare MYSQL_SERVER_USERNAME=$2
declare MYSQL_SERVER_PASSWORD=$3
declare MYSQL_SERVER_HOSTNAME=$4
declare AIRFLOW_DATABASE=$5
declare RABBITMQ_USERNAME=$6
declare RABBITMQ_PASSWORD=$7
declare RABBITMQ_HOSTNAME=$8
declare RABBITMQ_VHOST=$9
