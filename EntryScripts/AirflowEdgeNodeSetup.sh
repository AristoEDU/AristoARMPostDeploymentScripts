...
declare P_SA_USERNAME=${12}
declare P_SA_PASSWORD=${13}

# Setup the python environment
source InstallAndConfigurePyEnv.sh $P_SSH_USERNAME $P_PYTHON_VERSION
...
source DefineAirflowEnvironmentVariables.sh $P_SSH_USERNAME $P_AIRFLOW_DATABASE $P_MYSQL_SERVER_USERNAME $P_MYSQL_SERVER_PASSWORD $P_MYSQL_SERVER_HOSTNAME $P_RABBITMQ_QUEUENAME $P_RABBITMQ_VHOST $P_RABBITMQ_USERNAME $P_RABBITMQ_PASSWORD $P_RABBITMQ_HOSTNAME $P_SA_USERNAME $P_SA_PASSWORD
