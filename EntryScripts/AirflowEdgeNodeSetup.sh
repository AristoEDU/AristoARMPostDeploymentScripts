...
/bin/su -c "/var/lib/waagent/Microsoft.OSTCExtensions.CustomScriptForLinux-1.5.4/download/0/InitializeAirflow.sh $P_ENVIRONMENT $P_GITUSER $P_GITPASSWORD $P_SSH_USERNAME" - $P_SSH_USERNAME
